							...
							<div class="form-group">
								<label>NIP</label>
									<div class="input-group">
										...
										<input name="NIP" maxlength="9" type="text" class="form-control" required  placeholder="NIP"/>
									</div>
							</div>
							<div class="form-group">
								<label>Nama Guru</label>
									<div class="input-group">
										...
										<input name="Nama_Guru" type="text" class="form-control" required  placeholder="Nama Guru"/>
									</div>
							</div>
