<header class="main-header">
  <!-- Logo -->
  <div class="logo">
<span class="logo-mini"><img src="../aset/foto/smk.png" class="img-circle" alt="Logo" height="50" width="50"></span>
<span class="logo-lg"><b>Info Amga</b></span>
</div>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <p>Welcome To Info Amga</p>
            </li>
            <!-- Menu Footer-->
            <li class="user-footer">
               <div class="pull-left">
                <a href="#" data-target="#ModalEdit" data-toggle="modal"  class="btn btn-primary">Change Password <i class="fa fa-lock"></i></a>
              </div>
